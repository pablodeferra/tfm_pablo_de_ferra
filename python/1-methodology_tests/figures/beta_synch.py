...
ax_EE.axhline(-3.085, color='steelblue', lw=0.8, ls='--', zorder=1)
ax_EE.axhline(-3.079, color='w', lw=0.8, ls='--', zorder=1)
ax_EE.axhline(-3.113, color='goldenrod', lw=0.8, ls='--', zorder=1)

ax_BB.axhline(-2.999, color='steelblue', lw=0.8, ls='--', zorder=1)
ax_BB.axhline(-3.017, color='w', lw=0.8, ls='--', zorder=1)
ax_BB.axhline(-2.984, color='goldenrod', lw=0.8, ls='--', zorder=1)
...
save_transparent_white(
    ...
    os.path.join(ppt_dir, 'beta_s_vs_ell_bin_to_bin_transparent_pl_values.png'),
    dpi=300)
