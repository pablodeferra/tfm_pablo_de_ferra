...
# ---------------------------------------------------------------
MASK_STYLES = {
    'galcut10': dict(color='steelblue',  marker='o', label=r'$\pm10\degree$', offset=-5),
    'galcut15': dict(color='darkorange', marker='^', label=r'$\pm15\degree$', offset= 0),
    'galcut20': dict(color='firebrick',  marker='s', label=r'$\pm20\degree$', offset=+5),
}
...
for ax, mode, panel_label in [
    ...
    # right-side panel label in grey box (as in reference figure)
    ax.text(1.012, 0.5, panel_label,
            transform=ax.transAxes,
            va='center', ha='left', fontsize=13,
            bbox=dict(boxstyle='square,pad=0.25', fc='lightgrey',
                      ec='grey', lw=0.8))
